...
contract ERC721 is IERC721 {
    ...
    // Mapping from token id to apporved address
    ...
    function approve(address to, uint tokenId) external override {
        ...
        require(msg.sender == owner || _operatorApprovals[owner][msg.sender], "NOT OWNER NOR IS APPROVE FOR ALL");
    ...
    function _safeTransfer(address owner, address from, address to, uint tokenId, bytes memory _data) private {
        _transfer(owner, from, to, tokenId);
        require(_checkOnERC721Received(from, to, tokenId, _data), "NOT ERC172RECEIVER");
    }
